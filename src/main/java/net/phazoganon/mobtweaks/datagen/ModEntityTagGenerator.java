...
public class ModEntityTagGenerator extends EntityTypeTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(ModTags.Entities.MEDIUM_AGGRESSION).add(EntityType.SPIDER, EntityType.SKELETON, EntityType.STRAY, EntityType.PIGLIN, EntityType.CREEPER, EntityType.GUARDIAN, EntityType.WITCH, EntityType.CAVE_SPIDER);
